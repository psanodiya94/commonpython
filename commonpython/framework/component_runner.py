...
def run_component(component_class: Type[ComponentBase], component_name: str, 
...
def run_component_with_config(component_class: Type[ComponentBase], component_name: str,
