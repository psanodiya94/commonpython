...
class ComponentBase(ABC):
    ...
    def send_message(self, queue_name: str, message: Any, properties: Optional[Dict[str, Any]] = None) -> bool:
        """
    ...
    def receive_message(self, queue_name: str, timeout: Optional[int] = None) -> Optional[Dict[str, Any]]:
        """
